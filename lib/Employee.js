...
class Employee {
    viewEmployees() {
        const sql = `SELECT emp.id,emp.first_name,emp.last_name,role.title,department.name 
		as 'department',role.salary,concat(mgr.first_name,' ',mgr.last_name) as 'manager'
